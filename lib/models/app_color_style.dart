...
enum AppPalettePreset { sunset, lavender, sage, sherbet, blossom }
...
extension AppPalettePresetX on AppPalettePreset {
  AppPaletteData get palette {
    return switch (this) {
      ...
      AppPalettePreset.blossom => const AppPaletteData(
        label: 'Blossom',
        paper: Color(0xFFFF8787),
        muted: Color(0xFFF8C4B4),
        accent: Color(0xFFE5EBB2),
        ink: Color(0xFFBCE29E),
      ),
    };
  }
